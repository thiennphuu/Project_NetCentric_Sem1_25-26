...
const (
	...
	MangaService_ListManga_FullMethodName       = "/mangahub.MangaService/ListManga"
...
func (c *mangaServiceClient) SearchManga(ctx context.Context, in *SearchMangaRequest, opts ...grpc.CallOption) (*ListMangaResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListMangaResponse)
...
func (c *mangaServiceClient) GetUserProgress(ctx context.Context, in *GetUserProgressRequest, opts ...grpc.CallOption) (*UserProgressResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMangaServiceServer) SearchManga(context.Context, *SearchMangaRequest) (*ListMangaResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SearchManga not implemented")
}
func (UnimplementedMangaServiceServer) GetUserProgress(context.Context, *GetUserProgressRequest) (*UserProgressResponse, error) {
...
func _MangaService_GetUserProgress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MangaServiceServer).GetUserProgress(ctx, req.(*GetUserProgressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
